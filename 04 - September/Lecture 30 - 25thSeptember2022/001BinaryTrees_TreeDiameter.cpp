...
Pair computeDiameterEfficient(node* root) {
	...
	// 1. ask your friend to compute the height of the leftSubtree and simulataneously compute the diameter of the leftSubtree
	Pair pL = computeDiameterEfficient(root->left);

	// 2. ask your friend to compute the height of the rightSubtree and simulataneously compute the diameter of the rightSubtree
